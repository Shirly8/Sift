"""
Generates absa_training data via synthetic_augmentation.csv

Columns: review, aspect, rating
Dataloader.py automatically detects this

Uses environment variables: LLM_MODEL, LLM_API_KEY, LLM_BASE_URL
"""
...
if __name__ == "__main__":
    ...
    generator = SyntheticGenerator(model=os.getenv('LLM_MODEL', ''))
