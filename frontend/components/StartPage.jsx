    ...
    return (
        <div ref={containerRef}>
            ...
            <section className="opening">
                ...
                <div className="opening__links">
                    <a
                        href="https://youtu.be/qdhzzxOljrk?si=Nhdry_Ax6TcGjtzn"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="opening__link opening__link--primary"
                    >
                    ...
                    <button className="opening__link opening__link--secondary" onClick={openUploadModal}>
